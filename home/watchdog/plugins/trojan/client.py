#!/usr/bin/env python3
"""
Trojan плагин для watchdog.
Использует sing-box-trojan-client и порт 1086.
"""
import asyncio
import json
import sys
...
SOCKS_PORT = 1086
TUN_IFACE = "tun-trojan"
TUN_TMP = "tun-trojan-t"
CONTAINER_NAME = "sing-box-trojan-client"


class TrojanPlugin(BasePlugin):
    name = "trojan"
    pid_file = Path("/run/tun2socks-trojan.pid")
    _pid_file_tmp = Path("/run/tun2socks-trojan-t.pid")
