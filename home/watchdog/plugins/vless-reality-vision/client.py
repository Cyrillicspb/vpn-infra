#!/usr/bin/env python3
"""
VLESS+REALITY+Vision плагин для watchdog.
Использует xray-client-vision и порт 1084.
"""
import asyncio
import json
import sys
...
SOCKS_PORT = 1084
TUN_IFACE = "tun-vision"
TUN_TMP = "tun-vision-t"
CONTAINER_NAME = "xray-client-vision"


class VlessRealityVisionPlugin(BasePlugin):
    name = "vless-reality-vision"
    pid_file = Path("/run/tun2socks-vision.pid")
    _pid_file_tmp = Path("/run/tun2socks-vision-t.pid")
