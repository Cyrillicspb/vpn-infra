...
class DeployRestoreContractTests(unittest.TestCase):
    ...
    def test_admin_bot_texts_match_deploy_status_contract(self):
        ...
        self.assertIn("Hysteria2 paths:", admin_handler)
        ...
        self.assertIn("Auto-select", keyboards)
        self.assertIn("Сделать активным", keyboards)
        self.assertIn("Client backend prefs", keyboards)
        self.assertIn("Add client pref", keyboards)
        self.assertIn("adm:backend_pref_rm:", keyboards)
        self.assertIn("Gateway", keyboards)
        self.assertIn("LAN clients", keyboards)
        self.assertIn("LAN backend prefs", keyboards)
        ...
        self.assertIn('return await self._get("/decision/status")', watchdog_client)
        self.assertIn('return await self._get("/decision/backend-paths")', watchdog_client)
        ...
        self.assertIn('("🔐 Trojan", "trojan")', keyboards)
        self.assertIn('("🚀 TUIC", "tuic")', keyboards)
        ...
        self.assertIn('snapshot["execution_family"]', watchdog_source)
