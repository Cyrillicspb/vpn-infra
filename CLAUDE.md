...
- [ ] Удобный GUI-установщик: статичный экран с кнопками Далее/Назад, удобными полями ввода и возможностью исправить уже введённые значения, прогресс-баром на фиксированном месте, областью вывода консоли во время установки
