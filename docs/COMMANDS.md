...
/migrate-vps <IP> --from-backup        — восстановить ключи и конфиги из бэкапа на новый VPS
```
...
```
/rotate-keys           — ротация WireGuard ключей всех пиров; рассылает новые конфиги клиентам
/renew-cert            — обновить клиентский mTLS сертификат (TTL 2 года)
/renew-ca              — обновить CA сертификат (TTL 10 лет; делать редко, аннулирует все клиентские)
```
